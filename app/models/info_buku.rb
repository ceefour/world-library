...
class InfoBuku < ActiveRecord::Base
  set_table_name "InfoBuku"
  has_many :id_bukus, :foreign_key => "InfoIDBuku" 
 
  def self.per_page
    11
  end
  
  validates_presence_of "InfoIDBuku", "Judul"
  validates_uniqueness_of "InfoIDBuku"
