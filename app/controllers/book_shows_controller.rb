...
class BookShowsController < ApplicationController
  # If you want to know the application
  def show
    #    @info_bukus = InfoBuku.find(:all, :limit=>18, :order=>"InfoIDBuku ASC", :conditions => {"Kategori" => "KEB." })
    #    @id_bukus = IdBuku.find(:all, :limit=>18)
