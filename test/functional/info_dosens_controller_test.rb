...
require 'info_dosens_controller'

# Re-raise errors caught by the controller.
class InfoDosensController; def rescue_action(e) raise e end; end

class InfoDosensControllerTest < Test::Unit::TestCase
  def setup
    @controller = InfoDosensController.new
