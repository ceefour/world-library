...
require 'info_ktis_controller'

# Re-raise errors caught by the controller.
class InfoKtisController; def rescue_action(e) raise e end; end

class InfoKtisControllerTest < Test::Unit::TestCase
  def setup
    @controller = InfoKtisController.new
