...
require 'catalogues_controller'

# Re-raise errors caught by the controller.
class CataloguesController; def rescue_action(e) raise e end; end

class CataloguesControllerTest < Test::Unit::TestCase
  def setup
    @controller = CataloguesController.new
