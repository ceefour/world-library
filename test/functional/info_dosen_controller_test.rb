...
require 'info_dosen_controller'

# Re-raise errors caught by the controller.
class InfoDosenController; def rescue_action(e) raise e end; end

class InfoDosenControllerTest < Test::Unit::TestCase
  def setup
    @controller = InfoDosenController.new
