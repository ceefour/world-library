...
require 'circulations_controller'

# Re-raise errors caught by the controller.
class CirculationsController; def rescue_action(e) raise e end; end

class CirculationsControllerTest < Test::Unit::TestCase
  def setup
    @controller = CirculationsController.new
