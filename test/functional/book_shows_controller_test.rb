...
require 'book_shows_controller'

# Re-raise errors caught by the controller.
class BookShowsController; def rescue_action(e) raise e end; end

class BookShowsControllerTest < Test::Unit::TestCase
  def setup
    @controller = BookShowsController.new
