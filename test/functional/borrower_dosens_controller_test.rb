...
require 'borrower_dosens_controller'

# Re-raise errors caught by the controller.
class BorrowerDosensController; def rescue_action(e) raise e end; end

class BorrowerDosensControllerTest < Test::Unit::TestCase
  def setup
    @controller = BorrowerDosensController.new
