...
require 'about_libraries_controller'

# Re-raise errors caught by the controller.
class AboutLibrariesController; def rescue_action(e) raise e end; end

class AboutLibrariesControllerTest < Test::Unit::TestCase
  def setup
    @controller = AboutLibrariesController.new
