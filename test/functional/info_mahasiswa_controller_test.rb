...
require 'info_mahasiswa_controller'

# Re-raise errors caught by the controller.
class InfoMahasiswaController; def rescue_action(e) raise e end; end

class InfoMahasiswaControllerTest < Test::Unit::TestCase
  def setup
    @controller = InfoMahasiswaController.new
