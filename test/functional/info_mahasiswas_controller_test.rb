...
require 'info_mahasiswas_controller'

# Re-raise errors caught by the controller.
class InfoMahasiswasController; def rescue_action(e) raise e end; end

class InfoMahasiswasControllerTest < Test::Unit::TestCase
  def setup
    @controller = InfoMahasiswasController.new
