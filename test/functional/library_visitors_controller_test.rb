...
require 'library_visitors_controller'

# Re-raise errors caught by the controller.
class LibraryVisitorsController; def rescue_action(e) raise e end; end

class LibraryVisitorsControllerTest < Test::Unit::TestCase
  def setup
    @controller = LibraryVisitorsController.new
