...
require 'borrower_mahasiswas_controller'

# Re-raise errors caught by the controller.
class BorrowerMahasiswasController; def rescue_action(e) raise e end; end

class BorrowerMahasiswasControllerTest < Test::Unit::TestCase
  def setup
    @controller = BorrowerMahasiswasController.new
