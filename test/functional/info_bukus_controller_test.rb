...
require 'info_bukus_controller'

# Re-raise errors caught by the controller.
class InfoBukusController; def rescue_action(e) raise e end; end

class InfoBukusControllerTest < Test::Unit::TestCase
  def setup
    @controller = InfoBukusController.new
